            ...
            <form @submit.prevent="submit">
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="HR">Éditeur d'administration </option>
                    </SelectInput>
                ...
                <div class="flex ">
                    ...
                    <Link :href="route('users.index')" class="w-full text-black bg-white border-2 hover:border-gray-500 border  focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm mt-5 px-5 py-2.5 text-center">Cancel</Link>
                </div>
            </form>
        </div>
    </AuthenticatedLayout>
